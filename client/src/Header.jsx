...
export default function Header() {
    return(
        ...
        <div className='flex items-center gap-2 border border-gray-300 p-2 rounded-full px-4 shadow-md shadow-gray-300'>
          <div>Anywhere</div>
        ...
        <Link to='/login' className='flex items-center gap-2 border border-gray-300 p-2 rounded-full px-4 '>
